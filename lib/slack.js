...
function fmtSlack(event) {
  ...
  switch (event.type) {
    ...
    case 'IssueCommentEvent':
      text_fmt = ':speech_balloon: Commented on issue ' + event.payload.comment.html_url + '\n\r' + '> ' + event.payload.comment.body;
    ...
    case 'PullRequestReviewCommentEvent':
      text_fmt = ':speech_balloon: Commented on pull request ' + event.payload.comment.html_url + '\n\r' + '> ' + event.payload.comment.body;
      break;
    case 'MemberEvent':
      text_fmt = ':bust_in_silhouette: Added _' + event.payload.member.login + '_ to ' + friendly(event.repo.url)
      break;
    default:
